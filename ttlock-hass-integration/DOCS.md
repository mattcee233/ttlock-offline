...
Please see [ttlock-sdk-js Gateway option](https://github.com/mattcee233/ttlock-sdk-js#gateway-option) for running an example gateway server. I am currently working on porting this server to run on ESP32 devices.  
